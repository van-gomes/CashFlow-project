...
public class UpdateExpenseUseCaseTest
{
    ...
    public async Task Error_Title_Empty()
    {
        ...
        result.Where(ex => ex.GetErrors().Count == 1 && ex.GetErrors().Contains(ResourceErrorMessages.titleRequired));
    }
    ...
    public async Task Error_Expense_Not_Found()
    {
        ...
        result.Where(ex => ex.GetErrors().Count == 1 && ex.GetErrors().Contains(ResourceErrorMessages.expenseNotFound));
    }
