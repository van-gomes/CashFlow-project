...
public class UpdateExpenseTest : CashFlowClassFixture
{
    ...
    public async Task Error_Title_Empty(string culture)
    {
        ...
        var expectedMessage = ResourceErrorMessages.ResourceManager.GetString("titleRequired", new CultureInfo(culture));
    ...
    public async Task Error_Expense_Not_Found(string culture)
    {
        ...
        var expectedMessage = ResourceErrorMessages.ResourceManager.GetString("expenseNotFound", new CultureInfo(culture));
